...
function handleSetInstructions(arg0: { governedAccount: import("../../../../../../../utils/uiTypes/assets").GovernanceProgramAccountWithNativeTreasuryAddress | undefined; getInstruction: () => Promise<import("@utils/uiTypes/proposalCreationTypes").UiInstruction> }, index: number) {
